...
if wnoise:
	output_folder  = 'data/spectra_patches_radius'+str(radius)+'deg_sim_wnoise_gal080_MASTER_deltaell20/'
else:
	output_folder  = 'data/spectra_patches_radius'+str(radius)+'deg_sim_wonoise_gal080_MASTER_deltaell20/'
...
for i in xrange(start,end):
	if i < len(x):
		...
		if wnoise:
			...
			results['dltt'].append(est.get_spectra(sim_tt))#, analytic_errors=True)
