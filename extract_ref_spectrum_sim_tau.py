...
if wnoise:
	output_cl_file  = 'data/Dl_sim_wnoise_patchytau_nopixwin_beam_ptsrc_MASTER_delta20.dat'
else:
	# output_cl_file  = 'data/Dl_sim_wonoise_nopixwin_nobeam_nofilt_ptsrc_MASTER.dat'
	output_cl_file  = 'data/Dl_sim_wonoise_patchytau_nopixwin_beam_ptsrc_MASTER_delta20.dat'
